  ...
  return (
    <PageShell>
      <PageContainer>
        <Section>
          <SectionHeader>
            <Eyebrow>PROJECTS // CURATED ARCHIVE</Eyebrow>
            <PageTitle>Products, systems and software craft.</PageTitle>
            <BodyText>
          ...
          <div className="space-y-16">
            <div className="space-y-8">
              <div className="flex items-center justify-between gap-4 border-b border-black/10 pb-4">
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.35em] text-[#0d9488]">Featured work</p>
                  <p className="mt-2 text-sm text-slate-600">Pinned case studies with strong production impact and systems depth.</p>
                </div>
                <span className="rounded-full border border-black/10 bg-[#F7F5EF] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.25em] text-slate-600">
                  {featured.length} stories
                </span>
              </div>
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs leading-relaxed text-slate-600">{project.shortDescription}</p>
                        </div>
                      </div>
                  ...
                  {archive.map((project) => (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <span className="rounded-full bg-[#f1f6f4] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#0d9488]">
                          {statusLabels[project.status]}
                        </span>
                      </div>
                      <h3 className="mt-3 font-serif text-lg font-bold text-[#151515]">{project.title}</h3>
                      <p className="mt-3 text-xs text-slate-600">{project.shortDescription}</p>
                    </RouteLink>
                  ))}
                </div>
              </div>
